...
- **KCC-0001** (IzioDev): Defines the canonical covenant definition, state/argument codecs, entrypoint dispatch tags, P2SH envelope, and leader/delegator roles. This standard operates at the JSON level above KCC-0001's byte-level specification.
