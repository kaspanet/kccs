...
**metadata_uri** specifies an off-chain metadata resource for the token (name, ticker, decimals, governance charter). See KCC-0021 for canonical metadata layout.
